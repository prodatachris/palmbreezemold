...
export const areas = [
  // ══ BROWARD COUNTY ═════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Different, not automatically worse. The water table is high enough that slab moisture is a real factor, and salt air is hard on equipment. But the finger-isle homes are also frequently well maintained and heavily renovated. What we see there is more often a renovation detail than general neglect: a vapor-closed floor over a vapor-open slab, or an impact window retrofit with a sealant failure.',
      },
      {
...

  {
    ...
    intro: [
      ...
      'Then there is Plantation Acres, west of Flamingo Road, with one-acre-plus lots, horse-friendly zoning, and a large number of properties on well water and septic rather than city utilities. That last detail changes the problem enough that it gets its own answers below.',
    ],
...

  {
    ...
    intro: [
      ...
      'That configuration is fine until the building is pressurized differently than it was designed to be, say because a corridor makeup air unit has been off for two years, and then units start drawing air through the front door frame and the window wall instead. Combine that with a coil in a closet and you have a reliable growth condition.',
...

  {
    ...
    intro: [
      ...
      'A garage air handler sits in an unconditioned space that runs hot and humid. If the return plenum or the cabinet is not sealed, the system pulls garage air into the return on every cycle, and after thirty years of service calls, filter changes, and a coil replacement, it usually is not sealed. That air is warm, humid, and carrying whatever is in the garage. It hits a 42°F coil.',
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes, and this is genuinely more useful advice in Weston than almost anywhere else we work. The villages were built to a small number of plans in a short window, so a detail that failed in one house is likely to be identical in yours: a bath fan vented into the attic, an unsealed return plenum, a shower pan detail. Ask them what was found; it is a free head start.',
      },
      {
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'It changes the paperwork more than the work. In a co-op the corporation owns the building and you hold shares with a proprietary lease, so approval for work inside the unit, along with the question of whose insurance responds, runs through the board rather than through a condominium declaration. Practically, it means we get authorization in writing before starting rather than after, and we would rather establish that on day one than halfway through a containment.',
      },
    ],
  },
...

  {
    ...
    intro: [
      'The country-club build-out of Boca Del Mar, Broken Sound, Woodfield, Boca West, and Boca Bath & Tennis runs from the mid 1970s through the 1990s and includes an enormous volume of condominium, villa, and townhome stock alongside the single-family homes. A large share of it is occupied from November through April and closed the rest of the year.',
...

  {
    ...
    intro: [
      ...
      'What unites them is occupancy pattern. Seasonal residency at this scale means thousands of units sitting closed from May through October in the wettest, hottest part of the year, and the standard advice people give each other at the clubhouse, to set it to 80 and turn off the water, is precisely the advice that produces mold.',
    ...
    faqs: [
      {
        ...
        a: 'Set a humidity target of around 55% RH rather than a temperature, and make sure every conditioned structure on the property has one, not just the main house. Service the air conditioning on the way out rather than on the way back, and have somebody physically inside monthly reading the humidity. Eight months is long enough that a small drift becomes a large problem, and this is almost entirely preventable.',
      },
      {
...

  {
    ...
    intro: [
      ...
      'The mainland is a different city. West of the Intracoastal the stock is largely 1950s through 70s concrete block single-family: modest, low slabs, retrofitted central air. It behaves much like east Fort Lauderdale. We work both sides, but the questions people ask are not the same on each.',
    ],
